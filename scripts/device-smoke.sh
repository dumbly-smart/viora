...
if ! grep -Ei "text=\"viora\"|VIORA / VTOP|Connect VTOP|Good (morning|afternoon|evening)|content-desc=\"Home\"|content-desc=\"Schedule\"" "$OUTPUT_DIR/window.xml" >/dev/null; then
